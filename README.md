...
* **Main image**
  ...
  ![Main image](assets/readme-images/main-page-image.PNG)

   - The main image is designed to attract the customer's attention with delicious sweet called Jamoon.

* **About Us Section**

  ![About us section image](assets/readme-images/about-us-image.PNG)
...
* **Book Now Form**
  ...
  ![Book now form image](assets/readme-images/book-now.PNG)

    - The form allows the customer to book the table on a specific date directly from the business' website.

* **Find Us Section**
 
  ![Find us section image](assets/readme-images/find-us.PNG)
...
* The [W3C Markup Validator](https://validator.w3.org/) and [W3C CSS Validator](https://jigsaw.w3.org/css-validator/) services were used to validate all pages of the project in 
  ...
  ![W3C syntex error image](assets/readme-images/w3-html-validator.PNG)
    ...
    ![W3C syntex error solve image](assets/readme-images/w3-solve-validator.PNG)
 ...
 * Lighthouse reports
    ...
    ![Lighthouse report for home page image](assets/readme-images/homepage-lighthouse.PNG)

    - **Menu Page**

    ![Lighthouse report for menu page image](assets/readme-images/menu-page-lighthouse.PNG)

    - **Book Now Page**

    ![Lighthouse report for book now page image](assets/readme-images/book-now-lighthouse.PNG)
